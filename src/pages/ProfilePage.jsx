...
const ProfilePage = () => {
    return (
        <div className="Profile-page w-100 min-vh-100">
            ...
            <div className="struktur w-100 min-vh-100">
                <Container>
            ...
            <div className="sejarah w-100 min-vh-100">
                <Container>
